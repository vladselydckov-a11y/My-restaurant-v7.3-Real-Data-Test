...
export async function POST(request) {
  ...
  return NextResponse.json({
    ok: true,
    mode: 'v7_3_import_preview_sample',
    ...
    warning: 'v7.3 уже умеет собирать /api/summary из реальных таблиц Supabase. Если USE_SUPABASE=false, приложение останется в demo-live режиме.'
  });
}
